...
Exercise: Set the weights manually
----------------------------------
...
.. seealso::
   ...
   - `Video explaining the basics of neural networks <https://www.youtube.com/watch?v=aircAruvnKk>`__
   - `Overview of the most common Neural Network architectures <http://www.asimovinstitute.org/neural-network-zoo/>`__
